...
class _EnhancedMainDashboardState extends State<EnhancedMainDashboard>
  ...
  void initState() {
    ...
    // _startConnectionStatusTimer(); // Remove from here
  }
  ...
  void _initializeSocket() {
    try {
      print('📡 Initializing socket connection to: ${ApiService.nodeServerUrl}');
      ...
      socket!.on('joined_room', (data) {
        ...
        print('📱 Camera available: ${data['camera_available']}');
        print('📱 Mobile available: ${data['mobile_available']}');
      });
